...
public class FalsePosition extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        hdegree=(EditText)getActivity().findViewById(R.id.fpeditText);
        co=(EditText)getActivity().findViewById(R.id.fpeditText2);
        //textView=(TextView)getActivity().findViewById(R.id.textView6);
        display=(TextView)getActivity().findViewById(R.id.fptextview3);
        button=(Button)getActivity().findViewById(R.id.fpbutton);
            ...
            public void onClick(View v) {
                ...
                if (co.getText().toString().trim().equals("")) {
                    ...
                    while (Math.abs(a - b) > TOLERANCE) {
                        ...
                        c = (a * valueForb - b * valueFora) / (valueForb - valueFora);
                        f_of_c = function(coefficient, c);
                        if (f_of_c * valueFora < 0) {
                            b = c;
                        } else {
                            a = c;
                        }
